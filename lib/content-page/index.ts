const CONTENT_PAGE = {
  ...
  PAGE: {
    ...
    CART: {
      ...
      couponNotActive: "This coupon is not active",
    },
    SHIPPING_ADDRESS: {
    ...
    ADMIN_PRESELL: {
      managePresell: "Manage Presell",
    },
    ADMIN_UPSELL: {
      manageUpsell: "Manage Upsell",
    },
    ADMIN_COUPONS: {
      coupons: "Coupons",
      ...
      // Validation messages
      codeMinLength: "Coupon code must be at least 3 characters",
      codeMaxLength: "Coupon code must be at most 50 characters",
      discountMin: "Discount must be at least 0%",
      discountMax: "Discount must be at most 100%",
      startDateRequired: "Start date is required",
      endDateRequired: "End date is required",
      endDateAfterStartDate: "End date must be after start date",
      couponIdMissing: "Coupon ID is missing",
      active: "Active",
      inactive: "Inactive",
    },
    SEARCH: {
  ...
  COMPONENT: {
    ...
    PRESELL_FORM: {
      ...
      enablePresell: "Enable Presell",
      uncheckToHidePresell: "Uncheck to hide presell from cart",
      setPresell: "Set Presell",
      clearPresell: "Clear Presell",
      currentPresells: "Current Presells",
      ...
      disabled: "Disabled",
      clearing: "Clearing...",
      presellSetSuccessfully: "Presell set successfully",
      presellClearedSuccessfully: "Presell cleared successfully",
      failedToSetPresell: "Failed to set presell",
      failedToClearPresell: "Failed to clear presell",
    },
    UPSELL_FORM: {
      manageUpsell: "Manage Upsell",
      selectProduct: "Select product",
      enableUpsell: "Enable Upsell",
      uncheckToHideUpsell: "Uncheck to hide upsell from checkout",
      setUpsell: "Set Upsell",
      clearUpsell: "Clear Upsell",
      currentUpsell: "Current Upsell",
      productLabel: "Product:",
      statusLabel: "Status:",
      enabled: "Enabled",
      disabled: "Disabled",
      clearing: "Clearing...",
      upsellSetSuccessfully: "Upsell set successfully",
      upsellClearedSuccessfully: "Upsell cleared successfully",
      failedToSetUpsell: "Failed to set upsell",
      failedToClearUpsell: "Failed to clear upsell",
    },
    PRESELL_SECTION: {
    ...
    UPSELL_SECTION: {
      ...
      addToOrderDescription: "Add this product to your order and save!",
      noThanks: "No, thanks",
